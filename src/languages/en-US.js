...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		//	COMMAND_EVAL_OUTPUT: (time, output, type) => `\`${type} | ${time}\`\n**Output**:${output}`,
			...
			COMMAND_INVITE: () => 'Sorry, this bot is private, and is for the Sharkland Discord server!',
			COMMAND_INVITE_DESCRIPTION: 'Displays the invite link of the bot, to invite it to your guild.',
			COMMAND_INFO: 'Hey, I\'m Bean Bot, a bot designed for Jaws because he asked me to ¯\\_(ツ)_/¯',
